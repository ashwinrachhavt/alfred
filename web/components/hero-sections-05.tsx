    ...
    <section className="relative flex min-h-[92vh] flex-col items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        ...
        <div className="mb-8 flex items-center justify-center gap-3">
          ...
          <span className="text-primary text-[11px] tracking-[0.15em] uppercase">
            Knowledge Factory
          </span>
          <div className="bg-primary h-px w-8" />
        </div>
        ...
        {/* Tagline */}
        <p className="text-muted-foreground mx-auto mt-6 max-w-md text-lg leading-relaxed font-light">
          The things you know, sharpened.
        </p>

        {/* Description */}
        <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-[var(--alfred-text-tertiary)]">
          A knowledge workbench that captures, distills, and connects everything you learn — so
            ...
            <>
              <SignedOut>
                <Button asChild size="lg" className="text-sm tracking-wide">
                  <Link href="/sign-in">Begin Thinking</Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="text-sm tracking-wide">
        ...
        {/* Bottom accent line */}
        <div className="via-primary/40 mx-auto mt-16 h-px w-32 bg-gradient-to-r from-transparent to-transparent" />
      </div>
    </section>
  );
}
