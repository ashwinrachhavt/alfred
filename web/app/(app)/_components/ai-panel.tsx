...
export function AiPanel() {
  ...
  return (
    <aside className="border-l bg-muted/30 flex h-full w-[380px] shrink-0 flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center pt-12 text-center">
            ...
            <p className="text-muted-foreground text-sm">Ask anything about your knowledge</p>
