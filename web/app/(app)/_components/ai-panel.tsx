...
export function AiPanel() {
 ...
 className="rounded-sm border px-3 py-1.5 text-[11px] text-muted-foreground transition-colors hover:border-primary hover:text-foreground text-left"
 >
 {suggestion}
 </button>
 ))}
 ...
 className={cn(
 "rounded-full px-2.5 py-0.5 text-[10px] transition-colors border",
 activeLens === l.id
...
function PanelMessage({
 ...
 <span
 key={gap.concept}
 className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] bg-[var(--alfred-accent-subtle)] text-primary"
 >
 gap: {gap.concept}
 </span>
 ))}
