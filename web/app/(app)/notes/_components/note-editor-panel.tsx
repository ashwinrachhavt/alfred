...
export function NoteEditorPanel({
 ...
 action={
 <Button type="button" variant="outline" onClick={() => noteQuery.refetch()} className="text-xs">
 Retry
 </Button>
 }
 className="h-full"
 ...
 <span className="font-medium text-[10px] uppercase tracking-widest text-[var(--error)]">
 Save failed
 </span>
 <Button type="button" size="sm" variant="ghost" className="h-6 px-2 text-[10px]" onClick={() => void saveNow()}>
 Retry
 </Button>
 </div>
 )}
