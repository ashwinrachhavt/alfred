...
export function KnowledgeScore({ retention, coverage, connections }: Props) {
 ...
 <div>
 <h2 className="text-xl">Knowledge Score</h2>
 <div className="mt-2 flex gap-6">
 <div>
 <div className="font-data text-lg font-semibold tabular-nums">{retention}</div>
 <div className="font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">Retention</div>
 </div>
 <div>
 <div className="font-data text-lg font-semibold tabular-nums">{coverage}</div>
 <div className="font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">Coverage</div>
 </div>
 <div>
 <div className="font-data text-lg font-semibold tabular-nums">{connections}</div>
 <div className="font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">Connections</div>
 </div>
 </div>
 </div>
 </CardContent>
