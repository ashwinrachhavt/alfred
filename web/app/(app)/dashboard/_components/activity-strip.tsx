...
export function ActivityStrip() {
 ...
 <div className="mb-4 font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">
 Activity (7 days)
 </div>
 ...
 />
 <span className="text-[10px] text-[var(--alfred-text-tertiary)]">{d.label}</span>
 </div>
 ))}
 </div>
 </CardContent>
