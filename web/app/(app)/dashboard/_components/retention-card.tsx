...
export function RetentionCard() {
 ...
 <div className="font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">
 Retention
 </div>
 {isLoading ? (
 ...
 <span className="ml-2 text-xs font-normal text-muted-foreground">30-day</span>
 </div>
