...
export function ReviewFeynman({ zettels }: Props) {
 ...
 <p className="text-xl text-muted-foreground">No concepts to test</p>
 <p className="mt-2 text-xs text-[var(--alfred-text-tertiary)]">All concepts mastered</p>
 </div>
 );
 }
 ...
 <p className="text-2xl">Feynman Session Complete</p>
 <p className="mt-4 text-xs text-[var(--alfred-text-tertiary)]">
 {withGaps.length} concepts tested
 </p>
 <Button className="mt-6 text-xs" onClick={() => { setIndex(0); setSubmitted(false); setExplanation(""); }}>
 Start Over
 </Button>
 </div>
 );
 ...
 <div>
 <p className="font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)]">
 ...
 <div className="font-medium text-[9px] uppercase tracking-widest text-primary mb-1.5">
 Gap detected
 </div>
 <p className="text-[13px] leading-relaxed text-foreground">{gap.gap}</p>
 <p className="mt-2 text-[11px] text-[var(--alfred-text-tertiary)]">
 ...
 <div className="font-medium text-[9px] uppercase tracking-widest text-[var(--success)] mb-1.5">
 Strong explanation
 </div>
 ...
 {!submitted ? (
 <>
 <Button variant="outline" className="text-xs" onClick={handleNext}>
 Skip
 </Button>
 <Button className="text-xs" onClick={handleSubmit} disabled={!explanation.trim()}>
 Submit explanation
 </Button>
 </>
 ) : (
