...
export function ViewToolbar({ activeView, onViewChange, search, onSearchChange }: Props) {
 ...
 className="w-48 rounded-md border bg-transparent px-3 py-1.5 text-xs text-foreground outline-none placeholder:text-[var(--alfred-text-tertiary)] focus:border-primary"
 />

 <button className="flex items-center gap-1.5 rounded-md border border-dashed border-primary/40 px-3 py-1.5 text-[11px] uppercase tracking-wider text-primary/60 transition-colors hover:border-primary hover:text-primary">
