...
export function ZettelTable({ zettels, selectedId, onSelect }: Props) {
 ...
 const headerClass = "cursor-pointer select-none font-medium text-[10px] uppercase tracking-widest text-[var(--alfred-text-tertiary)] hover:text-foreground transition-colors text-left px-4 py-3";
 ...
 <span className="ml-1.5 text-[10px] text-[var(--alfred-text-tertiary)]">
 {BLOOM_LABELS[z.bloomLevel]}
 </span>
 </td>
 <td className="px-4 py-3 font-data text-sm tabular-nums">{z.connections.length}</td>
 <td className="px-4 py-3 text-[11px] text-[var(--alfred-text-tertiary)]">
 {z.lastReviewedAt
