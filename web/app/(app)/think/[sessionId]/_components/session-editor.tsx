...
export function SessionEditor({
 ...
 onBlur={() => void saveNow()}
 className="min-w-0 flex-1 bg-transparent text-xl tracking-tight outline-none placeholder:text-[var(--alfred-text-tertiary)]"
 ...
 <span
 className={cn(
 "mr-2 font-medium text-[10px] uppercase tracking-widest",
