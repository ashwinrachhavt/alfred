/**
 * Generates web/lib/streaming/events.ts.
 *
 * Phase 0: the generator emits a hand-curated TS discriminated union that
 * mirrors apps/alfred/streaming/events.py. A Python-side JSON-schema exporter
 * with full automation is a Phase 1 follow-up; for now, keep this file in
 * lock-step with events.py by re-running this script whenever events.py changes.
 */

import { writeFileSync } from "node:fs";
import { resolve } from "node:path";

const content = `// AUTO-GENERATED — do not edit by hand. Regenerate via web/scripts/gen-event-types.ts.
...
const out = resolve(process.cwd(), "lib/streaming/events.ts");
