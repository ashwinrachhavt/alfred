  ...
  return (
    <>
      ...
      <aside
        ...
        className={cn(
          "group z-50 flex h-dvh flex-col border-r bg-sidebar text-sidebar-foreground",
...
export function SidebarInset({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  ...
  return (
    <div
      ...
      style={{
        paddingLeft: isMobile ? undefined : open ? "var(--sidebar-width)" : "var(--sidebar-width-icon)",
      }}
      {...props}
    />
  )
...
export function SidebarHeader({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div
      ...
      className={cn("sticky top-0 z-10 border-b bg-sidebar/80 p-3 backdrop-blur", className)}
      {...props}
    />
  )
}
...
export function SidebarFooter({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div
      ...
      className={cn("sticky bottom-0 z-10 border-t bg-sidebar/80 p-3 backdrop-blur", className)}
      {...props}
    />
  )
}
