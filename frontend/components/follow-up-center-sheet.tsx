...
import { Bell, CalendarClock, CheckCircle2, Clock, Trash2 } from "lucide-react";
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex shrink-0 items-center gap-1">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            setFollowUpCenterOpen(false);
                            router.push(`/follow-ups?focus=${encodeURIComponent(item.id)}`);
                          }}
                        >
                          View
                        </Button>
