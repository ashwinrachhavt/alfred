...
class SystemPromptBuilder:
    ...
    def _tool_guidance() -> str:
        return (
            ...
            "### Notes\n"
            "- `import_notes_from_filesystem` — Import server-visible local text files or folders "
            "into Alfred Notes. Use when the user asks to import a folder, notes export, "
            "or local files into Notes. Ask for a path if they do not provide one.\n\n"
            "### Connections & Links\n"
            ...
            "### Learning & Review\n"
            "- `get_due_reviews` — Learning topics due for spaced repetition review.\n"
            "- `submit_review` — Record a learning review result.\n"
            "- `assess_knowledge` — Assess topic knowledge level using review history.\n"
            "- `generate_quiz` — Create quiz questions for a learning topic.\n"
            "- `feynman_check` — Evaluate a topic explanation using the Feynman technique.\n\n"
            "### Writing & Synthesis\n"
            ...
            "- `list_connectors`, `run_import`, `import_status` — Manage external data imports.\n\n"
